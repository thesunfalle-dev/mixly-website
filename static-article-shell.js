(() => {
  const COPY = {
    ru: { home: 'О приложении', features: 'Возможности', updates: 'Обновления', blog: 'Блог', download: 'Скачать в App Store', menu: 'Открыть меню', menuAria: 'Мобильная навигация', socials: 'Соцсети', contacts: 'Контакты', app: 'Приложение', docs: 'Документы', privacy: 'Конфиденциальность', cookies: 'Cookies и аналитика', terms: 'Условия использования', eula: 'Лицензия', support: 'Поддержка', age: 'Только для взрослых 18+', tagline: 'Идеи для кальяна, которые хочется сохранить' },
    en: { home: 'About', features: 'Features', updates: 'Updates', blog: 'Blog', download: 'Download on the App Store', menu: 'Open menu', menuAria: 'Mobile navigation', socials: 'Social', contacts: 'Contact', app: 'App', docs: 'Legal', privacy: 'Privacy', cookies: 'Cookies & analytics', terms: 'Terms of Use', eula: 'License', support: 'Support', age: 'Adults only 18+', tagline: 'Hookah ideas worth keeping' },
    de: { home: 'Über die App', features: 'Funktionen', updates: 'Updates', blog: 'Blog', download: 'Im App Store laden', menu: 'Menü öffnen', menuAria: 'Mobile Navigation', socials: 'Social', contacts: 'Kontakt', app: 'App', docs: 'Dokumente', privacy: 'Datenschutz', cookies: 'Cookies & Analysen', terms: 'Nutzungsbedingungen', eula: 'Lizenz', support: 'Support', age: 'Nur für Erwachsene 18+', tagline: 'Shisha-Ideen, die man behalten will' }
  };
  const ARTICLES = [
    {
      category: 'practice',
