...
const articles = [
  ...
  { paths: { ru: '/ru/blog/proportsii-tabaka-dlya-kalyana', en: '/en/blog/hookah-tobacco-mixing-ratios', de: '/de/blog/shisha-tabak-mischverhaeltnisse' }, copy: { ru: ['Пропорции табака для кальяна: как смешивать вкусы', 'Когда подходят 50/50, 70/30 и 60/30/10 и как не переборщить с акцентом.'], en: ['Hookah Tobacco Mixing Ratios', 'When to use 50/50, 70/30 and 60/30/10 without overdoing an accent.'], de: ['Shisha-Tabak: Mischverhältnisse', 'Wann 50/50, 70/30 und 60/30/10 sinnvoll sind und wie Akzente dosiert werden.'] } },
...
const ui = {
  ru: { home: 'О приложении', features: 'Возможности', updates: 'Обновления', blog: 'Блог', download: 'Скачать в App Store', menu: 'Открыть меню', menuAria: 'Мобильная навигация', app: 'Приложение', docs: 'Документы', privacy: 'Конфиденциальность', cookies: 'Cookies и аналитика', terms: 'Условия использования', eula: 'Лицензия', support: 'Поддержка', socials: 'Соцсети', age: 'Только для взрослых 18+', tagline: 'Идеи для кальяна, которые хочется сохранить', related: 'Читайте также', practice: 'Практика' },
  en: { home: 'About', features: 'Features', updates: 'Updates', blog: 'Blog', download: 'Download on the App Store', menu: 'Open menu', menuAria: 'Mobile navigation', app: 'App', docs: 'Legal', privacy: 'Privacy', cookies: 'Cookies & analytics', terms: 'Terms of Use', eula: 'License', support: 'Support', socials: 'Social', age: 'Adults only 18+', tagline: 'Hookah ideas worth keeping', related: 'Read next', practice: 'Practice' },
  de: { home: 'Über die App', features: 'Funktionen', updates: 'Updates', blog: 'Blog', download: 'Im App Store laden', menu: 'Menü öffnen', menuAria: 'Mobile Navigation', app: 'App', docs: 'Dokumente', privacy: 'Datenschutz', cookies: 'Cookies & Analysen', terms: 'Nutzungsbedingungen', eula: 'Lizenz', support: 'Support', socials: 'Social', age: 'Nur für Erwachsene 18+', tagline: 'Shisha-Ideen, die man behalten will', related: 'Weiterlesen', practice: 'Praxis' },
};
...
function header(lang, copy) {
  return `<header class="site-header" data-shell-static="true"><a class="brand brand-app" href="/">mixly</a><nav aria-label="${esc(copy.menuAria)}">${link('/#how-it-works', copy.home)}${link('/#features', copy.features)}${link('/#changelog', copy.updates)}${link('/blog.html', copy.blog)}</nav><div class="header-actions"><a class="header-cta" href="https://apps.apple.com/app/id6762792005" rel="noopener"><span class="cta-full">${esc(copy.download)}</span><span class="cta-short">App Store</span></a><div class="lang-switch" data-static-lang-switch><button type="button" class="lang-switch-toggle" aria-expanded="false" aria-label="Language">${lang.toUpperCase()}</button><ul class="lang-switch-menu" hidden role="radiogroup" aria-label="Language"><li><button type="button" data-lang="ru" role="radio" aria-checked="${lang === 'ru'}">RU</button></li><li><button type="button" data-lang="en" role="radio" aria-checked="${lang === 'en'}">EN</button></li><li><button type="button" data-lang="de" role="radio" aria-checked="${lang === 'de'}">DE</button></li></ul></div><button class="mobile-menu-toggle" type="button" aria-label="${esc(copy.menu)}" aria-controls="mobile-menu" aria-expanded="false"><span></span><span></span><span></span></button></div></header><aside class="mobile-menu" id="mobile-menu" aria-label="${esc(copy.menuAria)}" aria-hidden="true"><nav aria-label="${esc(copy.menuAria)}">${link('/#how-it-works', copy.home)}${link('/#features', copy.features)}${link('/#changelog', copy.updates)}${link('/blog.html', copy.blog)}</nav><div class="mobile-menu-socials"><p>${esc(copy.socials)}</p><div class="mobile-menu-social-links"><a href="https://www.instagram.com/get_mixly/" rel="noopener">Instagram</a><a href="https://www.threads.com/@get_mixly" rel="noopener">Threads</a></div></div></aside>`;
}

function footer(copy) {
  return `<footer class="site-footer"><div class="footer-main"><div class="footer-brand-block"><a class="brand-app footer-brand" href="/">mixly</a><p>Mixly app © 2026</p></div><div class="footer-links"><div><p>${esc(copy.app)}</p>${link('/#how-it-works', copy.home)}${link('/#features', copy.features)}${link('/#changelog', copy.updates)}${link('/blog.html', copy.blog)}<a href="https://apps.apple.com/app/id6762792005" rel="noopener">App Store</a></div><div><p>${esc(copy.docs)}</p>${link('/privacy.html', copy.privacy)}${link('/cookies.html', copy.cookies)}${link('/terms.html', copy.terms)}${link('/eula.html', copy.eula)}${link('/support.html', copy.support)}</div><div><p>${esc(copy.socials)}</p><a href="https://www.instagram.com/get_mixly/" rel="noopener">Instagram</a><a href="https://www.threads.com/@get_mixly" rel="noopener">Threads</a></div></div></div><div class="footer-bottom"><p>${esc(copy.age)}</p><p>${esc(copy.tagline)}</p></div></footer>`;
}
